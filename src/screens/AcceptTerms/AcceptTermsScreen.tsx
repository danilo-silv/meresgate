...
export const AcceptTermsScreen: RootStackScreenComponent<'AcceptTerms'> = ({ navigation }) => {
  ...
  const goToRefuseTerms = useCallback(() => navigation.navigate('RefuseTerms'), [navigation])
    ...
    <VStack flex={1}>
      <ScrollView showsVerticalScrollIndicator={false}>
        <VStack p={5} space={3}>
          ...
          <Checkbox onChange={toggleConfirm} value="1">
            <Text bold>Confirmo que li e concordo com os termos de uso e de confidencialidade</Text>
          </Checkbox>
        </VStack>
      </ScrollView>
      <VStack p={5} space={3}>
        ...
        <Button onPress={goToRefuseTerms} variant="ghost">
          Recusar
        </Button>
      </VStack>
    </VStack>
